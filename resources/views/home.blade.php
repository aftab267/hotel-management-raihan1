...
<div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
	  <div class="carousel-inner">
	    ...
	    <div class="carousel-item @if($index==0) active @endif">
	      <img height="100%" src="{{asset('uploads/banner/'.$banner->banner_src)}}" class="d-block w-100" alt="{{$banner->alt_text}}">
	    </div>
	    @endforeach
	  </div>
...
<div class="container my-4">
		...
		<div class="row my-4">
			<div class="col-md-3">
				<a href="{{url('service/'.$service->id)}}"><img class="img-thumbnail" style="width:100%;" src="{{asset('uploads/service/'.$service->photo)}}" /></a>
			</div>
			<div class="col-md-8">
				<h3>{{$service->title}}</h3>
